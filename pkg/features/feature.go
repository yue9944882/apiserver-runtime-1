...
const (
	...
	// beta: v1.0
	//
	// ArbitrarySubResource allows you to implement arbitrary kubernetes sub-resource
	// with custom logic.
	HTTPHandlerSubResource featuregate.Feature = "ArbitrarySubResource"
)
...
var DefaultKubeFedFeatureGates = map[featuregate.Feature]featuregate.FeatureSpec{
	HTTPHandlerSubResource: {Default: true, PreRelease: featuregate.Beta},
}
